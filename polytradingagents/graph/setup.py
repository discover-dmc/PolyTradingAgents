# polytradingagents/graph/setup.py
...
class GraphSetup:
    """Handles the setup and configuration of the PolyTradingAgents graph."""
    ...
    def setup_graph(self, selected_analysts: List[str] = None):
        """Set up and compile the PolyTradingAgents workflow graph.
        ...
        if not selected_analysts:
            raise ValueError("PolyTradingAgents Graph Setup Error: no analysts selected!")
